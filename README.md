...
| 任务名称 | 预计开发语言 | 预计时长 | 状态 |
| --------- | --------- | --------- | ----- |
| [hustsync.rs - Rust 重写镜像同步工具](./openatom_club_hustsync.md) | Rust | 2 个月 | **待认领** |
...
| [基于多级判定策略的漏洞影响范围智能化判定](./openatom_club_vulnerability_downstream_impact.md) | Python、C/C++、Golang | 3 个月 | **待认领** |
| [~~面向华科开放原子俱乐部的开源实习管理系统~~](./openatom_club_ossintern_web.md) | 不限（建议 Python / TS / Go） | 88 小时 / 6 周 | 已认领 |
| [~~基于 LLM 与代码分析的 OpenHarmony 智能漏洞检测工具~~](./openatom_club_LLM_vulnerability_detection.md) | Python、C/C++ | 88 小时 / 6 周 | 已认领 |
